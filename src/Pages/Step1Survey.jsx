...
export default class Step1Survey extends React.Component {
    ...
    */
    state = {
        ...
        instruction: 'Please select 5 movies that you have NOT watched before. You will need to answer 8 questions for each movie.',
    ...
    validateAns = () => {
        ...
        var big1 = this.state.big1
        var big2 = this.state.big2
        var big3 = this.state.big3
        var big4 = this.state.big4
        var big5 = this.state.big5
        ...
        if (big1==null||big2==null||big3==null||big4==null||big5==null){
            message.error('Please complete question')
            return false;
        }
        return true
    ...
    next = () => {
        if (this.validateAns()) {
            ...
            survey1['big'] = [parseInt(this.state.big1),parseInt(this.state.big2),parseInt(this.state.big3),parseInt(this.state.big4),parseInt(this.state.big5)]
            const cookies = new Cookies();
        ...
        return (
            ...
            <div>
                ...
                >
                    ...
                    <div className='question'>
                        <div className='title'>
                            9. I like to experience novelty and change in daily routine.
                    </div>
                    ...
                    <div className='question'>
                        <div className='title'>
                            10. I like activities that offer change and variety.
                    </div>
                    ...
                    <div className='question'>
                        <div className='title'>
                            11. I am continually seeking new ideas and experiences.
                    </div>
                    ...
                    <div className='question'>
                        <div className='title'>
                            12. I like to find new and unfamiliar experiences.
                    </div>
                    ...
                    <div className='question'>
                        ...
                        <Radio.Group onChange={this.onBig1Change} value={this.state.big1}>
                            cautious/consistent &ensp;
                            <Radio value={'1'}>1</Radio>
                            <Radio value={'2'}>2</Radio>
                            <Radio value={'3'}>3</Radio>
                            <Radio value={'4'}>4</Radio>
                            <Radio value={'5'}>5</Radio>
                            <Radio value={'6'}>6</Radio>
                            <Radio value={'7'}>7 &nbsp; curious/inventive</Radio>
                        </Radio.Group>
                    </div>
                    <div className='question'>
                        <div className='title'>
                        ...
                        <Radio.Group onChange={this.onBig2Change} value={this.state.big2}>
                            careless/easy-going &ensp;
                            <Radio value={'1'}>1</Radio>
                            <Radio value={'2'}>2</Radio>
                            <Radio value={'3'}>3</Radio>
                            <Radio value={'4'}>4</Radio>
                            <Radio value={'5'}>5</Radio>
                            <Radio value={'6'}>6</Radio>
                            <Radio value={'7'}>7 &nbsp; organized/efficient</Radio>
                        </Radio.Group>
                    </div>
                    <div className='question'>
                        <div className='title'>
                        ...
                        <Radio.Group onChange={this.onBig3Change} value={this.state.big3}>
                            solitary/reserved &ensp;
                            <Radio value={'1'}>1</Radio>
                            <Radio value={'2'}>2</Radio>
                            <Radio value={'3'}>3</Radio>
                            <Radio value={'4'}>4</Radio>
                            <Radio value={'5'}>5</Radio>
                            <Radio value={'6'}>6</Radio>
                            <Radio value={'7'}>7 &nbsp; outgoing/energetic</Radio>
                        </Radio.Group>
                    </div>
                    <div className='question'>
                        <div className='title'>
                        ...
                        <Radio.Group onChange={this.onBig4Change} value={this.state.big4}>
                            cold/unkind &ensp;
                            <Radio value={'1'}>1</Radio>
                            <Radio value={'2'}>2</Radio>
                            <Radio value={'3'}>3</Radio>
                            ...
                            <Radio value={'5'}>5</Radio>
                            <Radio value={'6'}>6</Radio>
                            <Radio value={'7'}>7 &nbsp; friendly/compassionate</Radio>
                        </Radio.Group>
                    </div>
                    <div className='question'>
                        <div className='title'>
                        ...
                        <Radio.Group onChange={this.onBig5Change} value={this.state.big5}>
                            secure/calm &ensp;
                            <Radio value={'1'}>1</Radio>
                            <Radio value={'2'}>2</Radio>
                            <Radio value={'3'}>3</Radio>
                            ...
                            <Radio value={'5'}>5</Radio>
                            <Radio value={'6'}>6</Radio>
                            <Radio value={'7'}>7 &nbsp; unconfident/nervous</Radio>
                        </Radio.Group>
                    </div>
