...
import { Checkbox, Row, Col, Radio, Table, Rate,  Typography } from 'antd';
...
export default class SurveyWithPoster extends React.Component {
  ...
  */
  ...
  createTableDate1 = () => {
    ...
    var data = [
      {key:0, Title: <p>This movie recommendation is <Text underline> not what I expected </Text>.</p>},
      {key:1, Title: <p>I would be <Text underline>surprised</Text> to see this recommendation.</p>},
      {key:2, Title: <p>I would <Text underline>not anticipate</Text> this movie being recommended.</p>},
      {key:3, Title: <p>This movie recommendation is <Text underline>unforeseen</Text>.</p>},
    ] 
    return data
  }
  createTableDate2 = () => {
    const { Text } = Typography;
    var data = [
      {key:4, Title: <p>This movie recommendation is a <Text underline>pleasant surprise</Text>.</p>},
      {key:5, Title: <p>The recommender system suggests an <Text underline>unexpected</Text> movie that seems <Text underline>worth a try</Text>.</p>},
      {key:6, Title: <p>This recommendation seems to be an <Text underline>interesting</Text> movie that I was <Text underline>not looking for</Text>.</p>},
      {key:7, Title: <p>I did <Text underline>not expect</Text> this movie to be recommended, but I would <Text underline>consider watching</Text> it.</p>},
    ] 
    return data
  }
