...
export default class Part1Modal extends React.Component {
  ...
  */
  ...
  validateSingleStep4Movie(movie) {
    ...
    var ans = movie.ans
    //if (title==null || title==''){
    if (title == null || title == '' ||ans[0] == 8 || ans[1] == 8 || ans[2] == 8 || ans[3] == 8 || ans[4] == 8 || ans[5] == 8 || ans[6] ==8
        || ans[7] ==8|| ans[8] ==8|| ans[9] ==8|| ans[10] ==8|| ans[11] ==8|| ans[12] ==8|| ans[13] ==8|| ans[14] ==8
        || ans[15] ==8|| ans[16] ==8|| ans[17] ==8|| ans[18] ==8|| ans[19] ==8){
      message.error('Please complete all questions')
      return false;
    } else {
      return true;
  ...
  done2() {
    ...
    if (this.validateSingleStep4Movie(survey4[0])) {
      ...
      var db = new window.restdb("5e3e82974c212c51488ad271"); //CORS cweiprod1-7a9d
      //var db = new window.restdb("90b00160c8f287ee6136a2ed4be3764b0d79a"); //cweiprod1-7a9d
    ...
    return (
      ...
      <div>
        ...
        >
          ...
          Imagine that this movie is recommended to you by the system, how would you <Text underline type="success"> rate this recommendation </Text>? 
          <br/>
          Please rate the degree to which you agree or disagree with each of the following 8 statements :
          </div>
