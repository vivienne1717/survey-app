                            ...
                            >
                                ...
                                <div className='step2-1'>
                                    <div className='Genre-filters' style={{ textAlign: 'left' }}>
                                        ...
                                        Survey Part 3:  
                                        <br/>
                                        Please select and rate 5 movies you WATHCED before. You will answer 8 questions for each movie.
                                        <br />
                                        You can browse the movie list according to the released year and genre of movies.
                                        <br />
                                        You can click on movie poster to see movie information.
                                        <br />
                                        You can select and rate a movie by hovering over the movie poseter.   
                                        </div>
